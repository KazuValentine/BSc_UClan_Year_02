...
Mattrix::Mattrix(const unsigned int& kRows, const unsigned int& kCols)
{
	mRows = kRows;
	mCols = kCols;
}

Mattrix::Mattrix(const Mattrix& kOriginal)
{
	mRows = kOriginal.mRows;
	mCols = kOriginal.mCols;
	mppMattrix = new double* [mRows];
...
Mattrix::Mattrix(const unsigned int& kRows, const unsigned int& kCols, double** ppMattrix)
{
	mRows = kRows;
	mCols = kCols;
	mppMattrix = new double* [mRows];
